...
var _SchoolPost = _interopRequireDefault(require("../models/SchoolPost.js"));
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return regeneratorRuntime.awrap(_SchoolPost["default"].find().limit(5).exec());
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.prev = 1;
          _context2.next = 4;
          return regeneratorRuntime.awrap(_SchoolPost["default"].find().populate('user').exec());

        case 4:
          schoolposts = _context2.sent;
          res.json(schoolposts);
          _context2.next = 12;
          break;
      ...
      switch (_context3.prev = _context3.next) {
        case 0:
          try {
            ...
            _SchoolPost["default"].findOneAndUpdate({
              _id: postId
            }, {
              $inc: {
                viewsCount: 1
              ...
              if (!doc) {
                return res.status(404).json({
                  message: 'Статья не найдена SchoolPostsController'
                });
              }
      ...
      switch (_context4.prev = _context4.next) {
        case 0:
          try {
            ...
            _SchoolPost["default"].findByIdAndDelete({
              _id: postId
            }, function (err, doc) {
              if (err) {
                console.log(error);
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          ...
          postId = req.params.id;
          _context6.next = 4;
          return regeneratorRuntime.awrap(_SchoolPost["default"].updateOne({
            _id: postId
          }, {
            title: req.body.title,
            text: req.body.text,
